				...
				try
				{
					switch (i)
					{
						...
						case 3:	
								...
								String respcan = addobj.cancelBooking(booking_id,username,roomno,date,room_slot,username.substring(0,3));
						...
						case 4:
								...
								System.out.print("\n\t\tEnter the old room name : ");
								oldroomno= input.readLine();
								System.out.print("\n\t\tEnter the old date : "); 
								olddate = input.readLine();
								System.out.print("\n\t\tEnter the old time slot : ");
							
								System.out.print("\n\tAvailable Slots :");
								System.out.println ("\n\n\t 1. 1-3 \n\t 2. 3-5 \n\t 3. 5-7 \n\t 4. 7-9 \n\t 5. 9-11 \n\t 6. 11-13 \n\t 7. 13-15 \n\t 8.15-17 \n\t 9.17-19 \n\t 10. 19-21 \n\t 11. 21-23 \n\t 12. 23-1"); 
								System.out.print("\n Enter your choice : ");
								oldtimeslotchoice=Integer.parseInt(input.readLine());
								switch(oldtimeslotchoice)
								{
										case 1: oldtimeslot="1-3";break;
										case 2: oldtimeslot="3-5";break;
										case 3: oldtimeslot="5-7";break;
										case 4: oldtimeslot="7-9";break;
										case 5: oldtimeslot="9-11";break;
										case 6: oldtimeslot="11-13";break;
										case 7: oldtimeslot="13-15";break;
										case 8: oldtimeslot="15-17";break;
										case 9: oldtimeslot="17-19";break;
										case 10: oldtimeslot="19-21";break;
										case 11: oldtimeslot="21-23";break;
										case 12: oldtimeslot="23-1";break;
								}
								...
								String respchreser = addobj.changeReservation(bookingid,oldroomno,olddate,oldtimeslot,username,username.substring(0,3),newroomno,newdate,newtimeslot);
