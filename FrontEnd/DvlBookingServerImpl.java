...
public class DvlBookingServerImpl
{
	int portno;
	...
	{
		String isavailable="";
		logfile="E:\\DvlCampus_Server_Logs_"+username+"_log.txt";
...
public static void main(String args[]) 
{
	...
	final String INET_ADDR = "224.4.5.8";
	final int PORT =9003;
	


	System.out.println(addobj.createRoom("RR1113","10-10-2010","1-3","DVLA1111"));
