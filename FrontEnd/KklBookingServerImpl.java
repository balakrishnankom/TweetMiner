...
public class KklBookingServerImpl
{
	int portno;
	...
	public String getAvailableTimeSlot(String date,String username,String campus)
	{
		...
		else
		{
			try
			{
				...
				System.out.println("DVL is being invoked:");
	...
	try
	{
		...
		System.out.println(logbook.trim());
		return ("\n"+logbook.trim()+"\n"+logcan.trim());
	}
...
public static void main(String args[]) 
{
	...
	final String INET_ADDR = "225.4.5.7";	
	final int PORT =9001;
	
	System.out.println(addobj.createRoom("RR1115","10-10-2010","1-3","WSTA1111"));
	...
	{	 
			public void run()
			{
				try
				{
					System.out.println("kkl server has been started :");
								...
								switch(Integer.parseInt(data[2]))
								{
										case 1:
												...
												result=addobj.bookRoom(roomno,date,timeslot,username,username.substring(0,3));
													...
													//KKL Cancel booking
													DatagramSocket cs2 = new DatagramSocket();
													InetAddress IP2= InetAddress.getByName("192.168.43.30");
													byte[] s2 = new byte[1024];
																			
													s2 = result.getBytes();
													
													DatagramPacket sp2 = new DatagramPacket(s2, s2.length, IP2, 8002);
													cs2.send(sp2);
													cs2.close();
										...
										case 2:
												...
												System.out.println("getavailable time slot invoked :");
