...
public class DvlBookingServerImpl
{
	...
	public String bookRoom(String no,String date,String timeslot,String username,String campus)
	{
		...
		String modifiedSentencedvlcount="",modifiedSentencekklcount="",modifiedSentencewstcount="";
		String return_value="";
		
		String return_valuecount="",return_valuedvl="",return_valuekkl="",return_valuewst="";
	...
	public String cancelBooking (String booking_id,String username,String no,String date,String timeslot,String campus)
	{
			...
			if(log=="")
				log=" Unable to cancel room! \tRoom no : "+no+"\t Date :"+date+"\t Time slot : "+timeslot;
