		...
		for(int i=0;i<9;i++)
		{
			if(login[i][0].equals(username))
			{
				if(login[i][1].equals(password))
				{
					...
					switch (camp) 
					{
						case "WST":name = "FE";break;
						case "DVL":name = "FE";break;
						case "KKL":name = "FE";break;
					}
				}
			}
		}
				...
				try
				{
					switch (i)
					{
						case 1:
								...
								String resp = addobj.bookRoom(roomno,date,room_slot,username);
						...
						case 2:
								...
								System.out.print("\n\t\t Enter the date : ");
								date= input.readLine();
								String repo=addobj.getAvailableTimeSlot(date,username);
						...
						case 3:	
								...
								String respcan = addobj.cancelBooking(booking_id,username);
