...
public class WstBookingServerImpl 
{
  ...
  @WebMethod
 public String changeReservation(String booking_id,String oldroomno,String olddate,String oldtimeslot,String username,String campus,String newroomno,String newdate,String newtimeslot)
 {
	...
	try
	{
			...
			if((return_valuedvl1.equals("Successful") || return_valuekkl1.equals("Successful")||return_valuewst1.equals("Successful")))
			{
				...
				if((return_valuedvl1.equals("Successful") || return_valuekkl1.equals("Successful")||return_valuewst1.equals("Successful")))
				{
							...
							String sentencedvl2 = "CANCELROOMDVL#"+booking_id+"#"+username+"#"+oldroomno+"#"+olddate+"#"+oldtimeslot;
							...
							{					
								...
								String sentencekkl2 = "CANCELROOMKKL#"+booking_id+"#"+username+"#"+oldroomno+"#"+olddate+"#"+oldtimeslot;
							...
							if(!return_valuecandvl2.equals("Successful") && !return_valuecankkl2.equals("Successful"))
							{
								...
								String sentencewst2 = "CANCELROOMWST#"+booking_id+"#"+username+"#"+oldroomno+"#"+olddate+"#"+oldtimeslot;
				...
				if((!return_valuecandvl2.equals("Successful") && !return_valuecankkl2.equals("Successful")&&!return_valuecanwst2.equals("Successful")))
				{
							...
							String sentencedvl3 = "CANCELROOMDVL#"+revert_bookid+"#"+username+"#"+newroomno+"#"+newdate+"#"+newtimeslot;
							...
							{					
								...
								String sentencekkl3 = "CANCELROOMKKL#"+revert_bookid+"#"+username+"#"+newroomno+"#"+newdate+"#"+newtimeslot;
							...
							if(!return_valuecandvl3.equals("Successful") && !return_valuecankkl3.equals("Successful"))
							{
								...
								String sentencewst3 = "CANCELROOMWST#"+revert_bookid+"#"+username+"#"+newroomno+"#"+newdate+"#"+newtimeslot;
