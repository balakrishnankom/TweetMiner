...
public class WstBookingServer extends UnicastRemoteObject implements RoomBookingInterface
{
...
public String cancelBooking (String bookingID,String username,String no,String date,String timeslot)throws RemoteException
{
  ...
  public static void main (String[] args)
  {
    try
    {
      WstBookingServer server = new WstBookingServer ();
      String name = "rmi://localhost:9999/WstBookingSystem";
