...
@WebService(endpointInterface = "webserv.RoomBookingInterface")
@SOAPBinding(style=Style.RPC)

public class KklBookingServerImpl implements RoomBookingInterface
{
 ...
 public String changeReservation(String booking_id,String username,String campus,String newroomno,String newdate,String newtimeslot)
 {
  	...
  	public static void main(String args[]) 
	{
		...
		Endpoint e = Endpoint.publish("http://localhost:8080/KklBookingServer", KklBookingServer);		
