...
public class StudentClient
{
	...
	{
		RoomBookingInterface remoteInterface;
		...
		for(int i=0;i<9;i++)
		{
			if(login[i][0].equals(username))
			{
				if(login[i][1].equals(password))
				{
					...
					switch (camp) 
					{
						case "WST":name = "http://localhost:8080/WstBookingServer?wsdl";break;
						case "DVL":name = "http://localhost:8080/DvlBookingServer?wsdl";break;
						case "KKL":name = "http://localhost:8080/KklBookingServer?wsdl";break;
					}
				}
			}
		}
		...
		try {
			...
			QName qName = new QName("http://webserv/", "KklBookingServer");
			...
			remoteInterface = service.getPort(RoomBookingInterface.class);		// similar to type-casting into proxy object
				...
				try
				{
					switch (i)
					{
						case 1:
								...
								String resp = remoteInterface.bookRoom(roomno,date,room_slot,username,(username.substring(0,3)));
						...
						case 2:
								...
								System.out.print("\n\t\t Enter the date : ");
								date= input.readLine();
								String repo=remoteInterface.getAvailableTimeSlot(date,username,(username.substring(0,3)));
						...
						case 3:	
								...
								String respcan = remoteInterface.cancelBooking(booking_id,username,username.substring(0,3));
						...
						case 4:
								...
								String respchreser = remoteInterface.changeReservation(bookingid,username,username.substring(0,3),newroomno,newdate,newtimeslot);
